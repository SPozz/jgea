...
import it.units.malelab.jgea.core.util.DoubleRange;
import it.units.malelab.jgea.core.util.Parametrized;
...
public class MultiLayerPerceptron implements Function<double[], double[]>, Parametrized {
